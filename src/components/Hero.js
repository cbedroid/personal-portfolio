...
const Hero = () => {
  ...
  return (
    <section id="welcome-section" className="bg-gray-800 text-white h-screen" style={{ backgroundImage: `url(${require("../assets/images/canvas.png")})` }}>
      <div className="flex flex-col items-center justify-center h-full">
        <div className="content-wrapper">
          <div className="content__text text-center text-4xl lg:text-5xl px-2">
            <TypingText color={typingFinish ? "transparent" : "#A61F5B"} textWrap={textWrap}>
              <h1 className="font-raleway mb-4">
                {textWrap ? "Hi I'm" : "Hello, My name is"} <span className="text-[#A61F5B] font-bold">Cornelius Brooks</span>.
              </h1>
            </TypingText>
