    ...
    <>
      {props?.src ? (
        <div className="project-tile relative group bg-[#efedec] shadow-xl sm:max-w-lg sm:mx-auto rounded-xl p-2 ">
          <div className="hidden group-hover:block absolute left-0 top-0 z-50 bg-white text-gray-800  h-full w-full sm:max-w-lg sm:mx-auto rounded-xl p-2 ">
              ...
              <a
                ...
                className={`font-medium leading-none rounded-l-none ${
                  !props.link
                    ...
                    : "text-indigo-700  hover:bg-indigo-600 border-2 hover:text-white border-indigo-700"
          ...
          <div className="max-w-md mx-auto">
            <h4
              tabIndex="0"
              className="focus:outline-none text-gray-800 dark:text-gray-100 text-xl font-bold mb-3 p-2"
            >
              {props?.name}
            </h4>
