...
# REDIRECTS
ADMIN_URL = os.getenv("DJANGO_ADMIN_URL", "/portfolio/admin/")
# ------------------------------------------------------------------------------
...
# Django Default Staticfiles-finder settings
STATICFILES_FINDERS = [
...
CORS_ALLOWED_ORIGINS = os.getenv("CORS_ALLOWED_ORIGINS", "http://localhost:8000 http://127.0.0.1:3000").split(" ")
